...
public class GridSecurityProcessorImpl extends GridProcessorAdapter implements GridSecurityProcessor {
    ...
    private SecurityPermissionSet getPermissionSet(Object login) {
        if (login.equals("secondSubject")) {
            return new SecurityPermissionSetBuilder()
                ...
                .appendCachePermissions("common_cache", SecurityPermission.CACHE_PUT, SecurityPermission.CACHE_READ)
                .build();
        }
    ...
    @Override public SecurityContext authenticateNode(ClusterNode node, SecurityCredentials credentials) {
    ...
    @Override public SecurityContext authenticate(AuthenticationContext context) {
    ...
    @Override public void authorize(String name, SecurityPermission perm, SecurityContext secCtx)
    ...
    @Override public SecuritySubject authenticatedSubject(UUID uuid) {
        return null;
    }
}
